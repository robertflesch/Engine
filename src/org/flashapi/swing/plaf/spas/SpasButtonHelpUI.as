...
/**
 * 	The <code>SpasButtonHelpUI</code> class is the SPAS 3.0 default look and feel
 ...
 */
public class SpasButtonHelpUI extends SpasButtonUI implements ButtonUI {
    ...
    public function SpasButtonHelpUI(dto:LafDTO) {
        dto.width = 20;
        dto.height = 20;
        super(dto);
    }
