...
/**
 * 	The <code>VVWindowUI</code> class is the SPAS 3.0 default look and feel
...
public class VVWindowUI extends VVUI implements WindowUI {
     ...
     */
    public function VVWindowUI(dto:LafDTO) {
        super(dto);
    }
    ...
    public function drawWindowArea():void {
        ...
        (dto.state == WindowState.MINIMIZED) ?
                f.drawRectangle(r.x, r.y, w, getTitleBarHeight() - 1.5) :
    ...
    private function drawWindowShape(minimized:Boolean = false):void {
        ...
        var h:Number = minimized ? getTitleBarHeight() : dto.outerHeight;
        var a:Number = dto.windowOpacity;
        var curveMiddle:Number = getTitleBarHeight() / 2;
        ...
        if (manager.texture != null) {
            ...
            //var color2:RGB = new RGB(0xFF0000);
