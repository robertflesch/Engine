...
package com.voxelengine.worldmodel.tasks.landscapetasks
{
	...
	{		
		public function GenerateVolcano( guid:String, layer:LayerInfo ):void {
			Log.out( "GenerateVolcano of type: " + (TypeInfo.typeInfo[layer.type].name.toUpperCase()) );					
			super( guid, layer, "GenerateVolcano: " + (TypeInfo.typeInfo[layer.type].name.toUpperCase()) );
		}
		...
		override public function start():void {
			...
			Log.out( "GenerateVolcano.start - highest point: " + highestPoint + "  out of : " + oxel.size_in_world_coordinates() );					
