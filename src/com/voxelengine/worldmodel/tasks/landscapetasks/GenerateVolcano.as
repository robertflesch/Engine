...
package com.voxelengine.worldmodel.tasks.landscapetasks
{
	...
	{		
		public function GenerateVolcano( guid:String, layer:LayerInfo ):void {
			Log.out( "GenerateVolcano of type: " + (Globals.typeInfo[layer.type].name.toUpperCase()) );					
			super( guid, layer, "GenerateVolcano: " + (Globals.typeInfo[layer.type].name.toUpperCase()) );
		}
		...
		override public function start():void {
			...
			Log.out( "GenerateVolcano - completed layer of type: " + (Globals.typeInfo[_layer.type].name.toUpperCase()) + "  range: " + _layer.range + "  offset: " + _layer.offset + " took: " + (getTimer() - timer) ); // + " in queue for: " + (timer - _startTime));
			//timer = getTimer();
