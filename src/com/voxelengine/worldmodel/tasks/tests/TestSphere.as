	...
	{		
		...
		override public function start():void
		{
			...
			if ( vm )
			{
				...
				var c:int = vm.modelInfo.oxelPersistence.oxel.size_in_world_coordinates() / 2;
				// 1 large spheres 
				//vm.oxel.write_sphere( c, c, c, c - 1, _layer.type, min_grain_size );
				vm.modelInfo.oxelPersistence.oxel.write_sphere( _modelGuid, c, c/2, c, c - 1, _layer.type, min_grain_size );
				/* 
				// 8 spheres 
