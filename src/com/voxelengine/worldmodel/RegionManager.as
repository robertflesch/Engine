...
//		var region:Region = regionGet( e.guid );
	...
	*/
	 ...
	 * Generates Event RegionEvent.REGION_UNLOAD if it is the current region
	 * Generates Event PersistanceEvent.LOAD_REQUEST if region does not exist, which should never happen.
	 * Generates Event RegionEvent.LOAD_REQUEST when region is loaded
	*/
