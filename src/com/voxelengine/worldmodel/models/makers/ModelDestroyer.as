...
public class ModelDestroyer {
	...
	public function ModelDestroyer( $modelGuid:String, $recursive:Boolean ) {
        ...
        Log.out("ModelDestroyer - attempting to remove modelGuid: " + $modelGuid + ( $recursive ? " and children from" : " from" ) + " persistence", Log.DEBUG );
        ...
        function dataResult( $mie:ModelInfoEvent):void {
            if ( $modelGuid == $mie.modelGuid ) {
                ...
                Log.out("ModelDestroyer - SUCCESSFULLY removed modelGuid: " + $modelGuid + ( $recursive ? " and children from" : " from" ) + " persistence", Log.DEBUG );
            }
        }
