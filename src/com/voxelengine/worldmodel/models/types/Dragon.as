...
*/	
	...
	override protected function cameraAddLocations():void {
		...
		//camera.addLocation( new CameraLocation( true, 16, Avatar.AVATAR_HEIGHT - 40, 50) );
		cameraContainer.addLocation( new CameraLocation( false, 16, Avatar.AVATAR_HEIGHT, 100) );
		cameraContainer.addLocation( new CameraLocation( false, 16, Avatar.AVATAR_HEIGHT, 250) );
	}
