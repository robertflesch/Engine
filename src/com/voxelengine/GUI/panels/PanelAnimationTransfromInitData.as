...
public class PanelAnimationTransfromInitData extends ExpandableBox
{
	...
	override protected function expand():void {
		...
		_itemBox.addElement( new ComponentVector3DSideLabel( function ():void { _ebco.rootObject.changed = true; _at.hasPosition = true }
		                                                   , "location", "X: ", "Y: ", "Z: ",  _at.position, _itemBox.width ) );
		_itemBox.addElement( new ComponentVector3DSideLabel( function ():void { _ebco.rootObject.changed = true; _at.hasRotation = true }
		                                                   , "rotation", "X: ", "Y: ", "Z: ",  _at.rotation, _itemBox.width ) );
		_itemBox.addElement( new ComponentVector3DSideLabel( function ():void { _ebco.rootObject.changed = true; _at.hasScale = true }
