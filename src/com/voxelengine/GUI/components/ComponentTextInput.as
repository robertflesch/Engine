...
{
	private var _li:VVTextInput;
	public function ComponentTextInput( label:String, changeHandler:Function, initialValue:String, $width:int, $height:int = 32, $padding:int = 5 )
	{
		super( $width, $height );
